        ...
        <div>
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="form-control">
              ...
              <input type="number" placeholder="Your age" className="input input-bordered" />
            </div>
            ...
            <div className="form-control md:col-span-2">
              <label className="label"><span className="label-text">Which warehouse you want to work?</span></label>
              <select className="select select-bordered">
